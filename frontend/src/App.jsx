...
import DynamicMasterManagement from "./pages/DynamicMasterManagement";
...
const operatorEselon1Nav = [
  ...
  {
    label: "Master Data",
    path: "/operator-eselon1/master-data",
    icon: "master",
  },
  {
    label: "Data Aplikasi",
    path: "/operator-eselon1/data-aplikasi",
    icon: "aplikasi",
  },
];
...
const operatorEselon2Nav = [
  ...
  {
    label: "Master Data",
    path: "/operator-eselon2/master-data",
    icon: "master",
  },
  {
    label: "Data Aplikasi",
    path: "/operator-eselon2/data-aplikasi",
    icon: "aplikasi",
  },
];
...
const operatorUPTNav = [
  ...
  {
    label: "Data Aplikasi",
    path: "/operator-upt/data-aplikasi",
    icon: "aplikasi",
  },
];
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="dynamic-master" element={<DynamicMasterManagement />} />
        ...
        <Route
          path="/operator-eselon1"
          element={
            <RequireAuth allowedRoles={["operatorEselon1"]}>
              <Layout navItems={operatorEselon1Nav} />
            </RequireAuth>
          }
        >
          <Route element={<OperatorEselon1Page />}>
            ...
            <Route
              path="data-aplikasi"
              element={<OperatorEselon1DataAplikasi />}
            />
            <Route path="profile" element={<OperatorEselon1Profile />} />
          </Route>
          <Route
            path="*"
            element={<Navigate to="/operator-eselon1" replace />}
          />
        </Route>

        {/* Operator Eselon 2 area */}
        <Route
          path="/operator-eselon2"
          element={
            <RequireAuth allowedRoles={["operatorEselon2"]}>
              <Layout navItems={operatorEselon2Nav} />
            </RequireAuth>
          }
        >
          <Route element={<OperatorEselon2Page />}>
            ...
            <Route
              path="data-aplikasi"
              element={<OperatorEselon2DataAplikasi />}
            />
            <Route path="profile" element={<OperatorEselon2Profile />} />
          </Route>
          <Route
            path="*"
            element={<Navigate to="/operator-eselon2" replace />}
          />
        </Route>
        ...
        <Route
          path="/operator-upt"
          element={
            <RequireAuth allowedRoles={["operatorUPT"]}>
              <Layout navItems={operatorUPTNav} />
            </RequireAuth>
          }
        >
