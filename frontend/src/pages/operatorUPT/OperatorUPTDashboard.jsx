...
function OperatorUPTDashboard() {
  ...
  const nama_upt = localStorage.getItem('namaUPT') ||
    userInfo.nama_upt ||
    userInfo.nama_unit ||
    '';
  ...
  const StatCard = ({ title, value, icon, gradient }) => (
    ...
    >
      ...
      <p style={{ margin: 0, color: "#64748b", fontSize: "12px", fontWeight: 600, letterSpacing: "-0.01em" }}>{title}</p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "#64748b", fontSize: "14px", fontWeight: 500, lineHeight: 1.4, marginTop: "4px" }}>
              Unit: <span style={{ fontWeight: 700, color: "#334155", fontSize: "15px" }}>{nama_upt ? nama_upt.toUpperCase() : 'UPT'}</span>
        ...
        <>
          ...
          <div style={{
            ...
            {recentUpdates.length === 0 ? (
              <p style={{ color: '#64748b', fontSize: '13px' }}>Tidak ada aplikasi terdaftar</p>
            ) : (
