...
function DynamicMasterManagement() {
  ...
  const fetchAvailableTables = async () => {
    try {
      // Hanya master data yang memang ada di halaman Master Data (tab)
      const staticTables = [
        { value: "frekuensi_pemakaian", label: "Frekuensi Pemakaian" },
        { value: "format_laporan", label: "Format Laporan" },
        { value: "eselon1", label: "Eselon 1" },
        { value: "eselon2", label: "Eselon 2" },
        { value: "upt", label: "UPT" },
        { value: "status_aplikasi", label: "Status Aplikasi" },
        { value: "environment", label: "Ekosistem" },
        { value: "cara_akses", label: "Cara Akses" },
        { value: "pdn", label: "PDN" },
      ];
      ...
      if (result.success) {
        ...
        dynamicTables = result.data
          .filter((t) => t.table_name !== currentTableName)
          .map((t) => ({
            value: t.table_name,
      ...
      const merged = [...staticTables, ...dynamicTables];
      const unique = Array.from(
        new Map(merged.map((t) => [t.value, t])).values(),
      );
                ...
                >
                  ...
                  >
                    ...
                    <div>
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  if (e.target.checked) {
                                    ...
                                    newRelations =
                                      formData.table_relations.filter(
                                        (r) => r !== value,
                                      );
                                  }
                                  setFormData({
                      ...
                      >
                        Pilih tabel yang berelasi (bisa lebih dari satu, atau
                        pilih "Tidak Ada Relasi")
                      </small>
                    </div>
                  </div>
                </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ fontSize: "11px", color: "#94a3b8" }}>
                            Atur nama, tipe, dan aturan kolom
                          </div>
                        </div>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            cursor: "pointer",
                            fontWeight: 700,
                            boxShadow: "0 2px 6px rgba(239, 68, 68, 0.20)",
                          }}
                        >
                          Hapus
                        </button>
