...
function OperatorEselon1Dashboard() {
  ...
  const nama_eselon1 =
    localStorage.getItem("namaEselon1") ||
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, chartRes, updatesRes] = await Promise.all([
        fetch(
          `http://localhost:5000/api/dashboard/operator/statistics?eselon1_id=${eselon1_id}`,
        ),
        fetch(
          `http://localhost:5000/api/dashboard/operator/chart?eselon1_id=${eselon1_id}`,
        ),
        fetch(
          `http://localhost:5000/api/dashboard/operator/recent-updates?eselon1_id=${eselon1_id}&limit=10`,
        ),
      ]);
                          ...
                          >
                            <span
                              style={{
                                ...
                                fontSize: "8px",
                                fontWeight: 700,
                                background: update.action_type === 'CREATE' 
                                  ? "linear-gradient(135deg, #dcfce7 0%, #bbf7d0 100%)"
                                  : "linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%)",
                                color: update.action_type === 'CREATE' ? "#166534" : "#1e40af",
                                border: update.action_type === 'CREATE' 
                            ...
                            >
                              {update.action_type === 'CREATE' ? 'BARU' : 'UPDATE'}
                            </span>
                          </td>
                          <td
                            style={{
