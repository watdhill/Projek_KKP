function OperatorEselon2DataAplikasi() {
  return (
    <section className="page-section">
      <h1 style={{ margin: '0 0 12px', fontSize: '26px', fontWeight: 700, color: '#1e293b' }}>
        Data Aplikasi (Operator Eselon 2)
      </h1>
      ...
      <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '10px', padding: '16px' }}>
        <p style={{ margin: 0, color: '#64748b' }}>Konten data aplikasi khusus Operator Eselon 2.</p>
      </div>
    </section>
  );
}
