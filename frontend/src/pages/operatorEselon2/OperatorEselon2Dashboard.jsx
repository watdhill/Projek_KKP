...
function OperatorEselon2Dashboard() {
  ...
  const nama_eselon2 =
    localStorage.getItem("namaEselon2") ||
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, chartRes, updatesRes] = await Promise.all([
        fetch(
          `http://localhost:5000/api/dashboard/operator/statistics?eselon2_id=${eselon2_id}`,
        ),
        fetch(
          `http://localhost:5000/api/dashboard/operator/chart?eselon2_id=${eselon2_id}`,
        ),
        fetch(
          `http://localhost:5000/api/dashboard/operator/recent-updates?eselon2_id=${eselon2_id}&limit=10`,
        ),
      ]);
